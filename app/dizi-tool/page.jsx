export default function DiziTool() {
  return (
    <>
    ...
    <section className="work section" id="work">
        <h2 className="section-titlee">Project: <span className="section-title">Digi Store</span> </h2>
            
        

        <div className="work__container bd-grid">
            <div className="work__container">
                <h1>➢ Technology Used: React.js | Node.js | Express | MongoDB | Tailwind CSS</h1>
            
            
                <a target="_blank" href="#" className="button">Live Site</a>
                <a target="_blank" href="#" className="button"> Client
                </a>
                <a target="_blank" href="#" className="button"> Server
                </a>
            </div>
